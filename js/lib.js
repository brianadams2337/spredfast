(function($) {
  ...
  leaderboardPoller = new Poller ({
    frequency:15,
    limit:5
  }, function(){spredfast.updateLeaderboard('#leaderboardId', this.processData(), this.currentStandings);})
  leaderboardPoller.currentStandings = []; // empty array to hold current leaderboard standings within the leaderboardPoller object
